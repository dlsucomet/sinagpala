              ...
              <div className={classes.dataColumn}>
                <div className={classes.infoBlock}>
                  ...
                  <Typography sx={{ fontSize: '12px' }}>
                    <sup>1</sup> The annual total energy is a representation of the total buildings that the built methodology was able to predict and calculate. This does not account for all buildings of Marikina City.
                  </Typography>
                </div>
              </div>
            </Item>
